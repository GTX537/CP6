...
public static class I18nA5BudgetScreenSeed
{
    public static readonly Sys_Lang[] Items = new[]
    {
        ...
        new Sys_Lang { LangKey = "budget.workbench.subtitle", ZhCN = "预算方案管理、版本编制与审批，分期金额录入", ZhTW = "預算方案管理、版本編制與審批，分期金額錄入", En = "Manage budget plans, version drafting & approval, period amounts entry", Ja = "予算案管理、バージョン編成・承認、期間金額入力", Ko = "예산 방안 관리, 버전 편성·승인, 기간 금액 입력" },
        ...
        // ── 视图标题（中文自然语言 key，供 page-header 直接 t() 用，避免裸键）──
        new Sys_Lang { LangKey = "预算编制", ZhCN = "预算编制", ZhTW = "預算編制", En = "Budget Planning", Ja = "予算編成", Ko = "예산 편성" },
        new Sys_Lang { LangKey = "执行分析", ZhCN = "执行分析", ZhTW = "執行分析", En = "Budget vs Actual", Ja = "予実分析", Ko = "예실 분석" },
        // ── 字段标签 ──
        new Sys_Lang { LangKey = "budget.field.budgetNo", ZhCN = "方案编号", ZhTW = "方案編號", En = "Budget No.", Ja = "予算案番号", Ko = "방안 번호" },
        new Sys_Lang { LangKey = "budget.field.budgetName", ZhCN = "方案名称", ZhTW = "方案名稱", En = "Budget Name", Ja = "予算案名称", Ko = "방안 이름" },
        ...
        // ── 按钮 ──
        new Sys_Lang { LangKey = "budget.btn.createBudget", ZhCN = "新建方案", ZhTW = "新建方案", En = "New Budget", Ja = "予算案新規", Ko = "방안 생성" },
        ...
        // ── 消息/提示 ──
        new Sys_Lang { LangKey = "budget.msg.created", ZhCN = "方案已创建", ZhTW = "方案已建立", En = "Budget created", Ja = "予算案を作成しました", Ko = "방안이 생성되었습니다" },
        ...
        new Sys_Lang { LangKey = "budget.msg.deactivated", ZhCN = "方案已停用", ZhTW = "方案已停用", En = "Budget deactivated", Ja = "予算案を無効化しました", Ko = "방안이 비활성화되었습니다" },
        ...
        new Sys_Lang { LangKey = "budget.msg.deactivateConfirm", ZhCN = "确认停用此预算方案？", ZhTW = "確認停用此預算方案？", En = "Deactivate this budget plan?", Ja = "この予算案を無効化しますか？", Ko = "이 예산 방안을 비활성화하시겠습니까?" },
        ...
        // ── 错误码 E-A5-* ──
        new Sys_Lang { LangKey = "E-A5-BUDGET-001", ZhCN = "该财年已存在预算方案（财年唯一）", ZhTW = "該財年已存在預算方案（財年唯一）", En = "A budget plan already exists for fiscal year {0}", Ja = "会計年度 {0} の予算案が既に存在します", Ko = "회계연도 {0}의 예산 방안이 이미 존재합니다" },
        new Sys_Lang { LangKey = "E-A5-BUDGET-404", ZhCN = "预算方案不存在", ZhTW = "預算方案不存在", En = "Budget plan not found", Ja = "予算案が見つかりません", Ko = "예산 방안을 찾을 수 없습니다" },
        ...
        // ── BudgetEditView 补充词条 ──
        new Sys_Lang { LangKey = "budget.panel.budgets", ZhCN = "预算方案", ZhTW = "預算方案", En = "Budget Plans", Ja = "予算案", Ko = "예산 방안" },
        new Sys_Lang { LangKey = "budget.msg.noBudgets", ZhCN = "暂无预算方案，请新建", ZhTW = "暫無預算方案，請新建", En = "No budget plans. Create one to start.", Ja = "予算案がありません。新規作成してください", Ko = "예산 방안이 없습니다. 생성하세요" },
