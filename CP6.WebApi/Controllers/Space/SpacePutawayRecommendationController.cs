...
[ApiController]
[Authorize]
[Route("api/space/operations/v1/sites/{siteId:guid}/putaway-recommendations")]
...
[ProducesResponseType(
    ...
    "application/problem+json")]
public sealed class SpacePutawayRecommendationController(
    ISpacePutawayRecommendationService service) : ControllerBase
{
    ...
    [ProducesResponseType<GenerateSpacePutawayRecommendationResponse>(
        StatusCodes.Status200OK)]
    public Task<GenerateSpacePutawayRecommendationResponse> Generate(
        Guid siteId,
        Guid recommendationId,
        [FromBody, Required] GenerateSpacePutawayRecommendationRequest request,
    ...
    [RequirePermission(
        ...
        UseProblemDetails = true)]
    [ProducesResponseType<SpacePutawayRecommendationDto>(
        StatusCodes.Status200OK)]
    public Task<SpacePutawayRecommendationDto> Get(
        Guid siteId,
        Guid recommendationId,
        CancellationToken cancellationToken = default) =>
        service.GetAsync(
