...
namespace CP6.Core.Migrations
{
    ...
    [Migration("20260910043605_CrmIdentityEvents")]
    public partial class CrmIdentityEvents : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // CP6Context is the sole migration owner. The other context gives the dispatcher
            // an independent budget, but its tables are created in this same forward migration.
            foreach (var operation in new IdentityPriority.CrmIdentityPriority().UpOperations)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Issuer = table.Column<string>(type: "varchar(512)", unicode: false, maxLength: 512, nullable: false, collation: "Latin1_General_100_BIN2"),
                    Jti = table.Column<string>(type: "varchar(36)", unicode: false, maxLength: 36, nullable: false, collation: "Latin1_General_100_BIN2"),
                    ClientId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false, collation: "Latin1_General_100_BIN2"),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceToken", x => new { x.Issuer, x.Jti });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AggregateId = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false, collation: "Latin1_General_100_BIN2"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Snapshot", x => new { x.TenantId, x.AggregateId });
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceToken_TenantId_ClientId_ExpiresAtUtc",
                schema: "crm_identity",
                table: "ServiceToken",
                columns: new[] { "TenantId", "ClientId", "ExpiresAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_Snapshot_TenantId_UpdatedAtUtc",
                schema: "crm_identity",
                table: "Snapshot",
