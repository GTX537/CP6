...
R00 文档票已把 CRM V1 锁定的 GHCR/GitHub R2 唯一候选权威、Azure 非权威边界和系统级回退写入 Proposed ADR，并建立 M0 就绪清单。当前 M0 明确为 No-Go：DEC-CRM-001 仍缺 named approval，DEC-CRM-002–007、Sponsor/各 Owner、Pilot cohort、Observation Gate 和真实 Azure SQL/Emergency Intake 证据均未关闭。`GTX537/CP6.CRM` 不在此阶段提前建立，只在 M0 全部 Approved 且后续 P01 runner/合同可消费后由独立 `CRM01-S01` 创建。
