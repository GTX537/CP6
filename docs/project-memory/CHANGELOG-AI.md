...
- 增加 R00 R2 勘误和 [P10 参考](../devops/P10-PLATFORM-REFERENCE.md) / [运行手册](../devops/HOWTO-P10-PLATFORM-CANDIDATE.md)，同步四份台账。实际本地全量验证 1528/1528、零跳过，format/actionlint 通过；正式作者仍为 PinnedSelfSigned，不宣称 public CA trust。
