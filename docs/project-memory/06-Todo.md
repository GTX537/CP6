...
- 先完成 M0/R00 ADR，并取得 Sponsor、Product、Sales Operations、Architecture、Security、Data、ERP、SRE、QA、Release 的 named Owner、Pilot cohort 与 Observation Gate 证据；缺失即 No-Go，任何团队不得自行发明仓库、身份、消息、数据或采用口径。
...
- Intake 必须覆盖人工录入和官网公开提交、线索池、分配/移交、协作人、活动时间线、4 个租户业务小时 SLA、重复候选与受控合并；数据范围按负责人、协作人、部门和管理员显式校验。
