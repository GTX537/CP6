...
- WP4 详细 Spec LM-FR-017、LM-FR-018、LM-FR-020、LM-FR-022、LM-FR-023、LM-FR-024 已有仓库实现；构件库已补齐托盘及输送线、AGV、叉车、工作台、电子秤、充电站六类静态设备，并具备业务编码、Design 属性、公共撤销/重做及 2D/3D 同源证据。下一独立任务优先复核 LM-FR-021 的两点实距标定、原点和旋转交互，再逐项核对 LM-FR-025～029 与三条路径剩余缺口。上述仓库闭环不自动把 WP4 标回 Complete，也不得用 Mock/fixture 替代真实 DWG/DXF/Excel/PDF、Provider、WMS 与 Pilot 接受。
