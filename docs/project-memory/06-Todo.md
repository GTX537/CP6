...
- Release 绑定评测器的 `1.0.0-rc.1` 已对正式 20 份 CAD 双跑通过，99.727873% 支持、P95 3.952 秒、SourceRef/Blocking/残留为 0。先合并评测器，再从新的精确 `main` 重建正式 `1.0.0` 并重跑；RC SHA 不得写入正式 Site 认证或 accepted evidence。
