...
- WP4 详细 Spec LM-FR-017、LM-FR-018、LM-FR-020～024 已有仓库实现；两点实距标定现提供 P1 原点、P2 比例点、独立 V 验证点、真实距离、原点、旋转和冻结误差阈值，构件库也已补齐托盘与六类静态设备。下一独立任务从 LM-FR-025～029 开始逐项核对三条路径剩余缺口。上述仓库闭环不自动把 WP4 标回 Complete，也不得用 Mock/fixture 替代真实 DWG/DXF/Excel/PDF、Provider、WMS 与 Pilot 接受。
