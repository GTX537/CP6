...
- P10 当前下一步是 S06 完整分支审查、正常 PR/exact-main 验证，再按[运行手册](../devops/HOWTO-P10-PLATFORM-CANDIDATE.md)执行 owner 批准的 validation、同源条件 publication 和完成后的只读 audit。实现已通过本地 1528/1528 无跳过测试、format 和 actionlint；这些不能代替真实 hosted/OCI/R2 门禁或审批。
