...
- 当前 WP6 任务卡门禁：完整 Release solution 0 warning / 0 error；Space Unit 506/506、CP6.Tests 2,877 passed / 19 environment-gated skipped、Client 71/71、Space Integration 305 passed / 104 SQL/environment-gated skipped、Web 763/763、发布管理聚焦 5/5、OpenAPI 聚焦 42/42、Vue type-check、production build、OpenAPI/C#/TypeScript SDK drift 和 diff whitespace 通过。发布相关 SQL 用例因本机未配置 `CP6_TEST_SQLSERVER` 而 skipped，不计为真实 SQL/WMS 证据；合并后仍执行聚焦冒烟。
