...
- 当前累计仓库门禁：完整 Release solution 0 warning / 0 error；Space Unit 506/506、CP6.Tests 2,913 passed / 19 environment-gated skipped、Client 71/71、Space Integration 305 passed / 104 SQL/environment-gated skipped、Web 763/763、Viewer 性能聚合单测 5/5、Viewer CPU 性能 1/1、Iris Xe 正式冷运行 30/30、发布管理聚焦 5/5、恢复指标/告警合同 6/6、外部主体矩阵 30/30、权限/OpenAPI/主体边界聚焦 111/111、Vue type-check、production build、OpenAPI/C#/TypeScript SDK drift 和 diff whitespace 通过。发布相关 SQL 用例因本机未配置 `CP6_TEST_SQLSERVER` 而 skipped，不计为真实 SQL/WMS 证据；合并后仍执行聚焦冒烟。
- 本项完成的是仓库核心实现、自动化和当前 SHA 的 Viewer 硬件性能门禁，不代表 GA：真实主/备 DWG Provider、20 份授权黄金 CAD、生产 Published-only Viewer 核验、独立 UX/辅助技术验收、两仓各 14 天 Pilot、WMS 恢复演练和五角色签字仍未完成。
