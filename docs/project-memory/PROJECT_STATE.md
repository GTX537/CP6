...
- 当前累计仓库门禁：完整 Release solution 0 warning / 0 error；Space Unit 525/525、CAD Converter/IR 聚焦 23/23、Provider 评分与 CAD Experiment 工具 34/34、CP6.Tests 2,916 passed / 19 environment-gated skipped、Client 71/71、Space Integration 319 passed / 107 SQL/environment-gated skipped、Web 775/775、Provider/Preparation/Parse 聚焦 33/33、OpenAPI 聚焦 43/43、Published Viewer 聚焦 12/12、Viewer 性能聚合单测 5/5、Viewer CPU 性能 1/1、Iris Xe 正式冷运行 30/30、发布管理聚焦 5/5、恢复指标/告警合同 6/6、外部主体矩阵 30/30、权限/OpenAPI/主体边界聚焦 112/112、GA 证据索引 2/2、Vue type-check、production build、OpenAPI/C#/TypeScript SDK drift、EF pending-model 和 diff whitespace 通过。新增 Provider 版本/资格与 Published/Draft 隔离等 SQL 用例因本机未配置 `CP6_TEST_SQLSERVER` 而 skipped，不计为真实 SQL/WMS 证据；合并后仍执行聚焦冒烟。
