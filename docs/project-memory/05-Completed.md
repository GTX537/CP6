...
用户因无真实业务数据明确批准验收v2。C01/C02/C03/C04A既有20%权重及成功证据保持，C04B通过[本轮证据](../evidence/c04b/2026-09-16/simulated-exit/README.md)：20表旧生产模型/状态机退出、静态阻塞8→0、37项定向检查全部通过、20条模拟旧记录保留、独立发布257文件及HTTP三项200、临时库清理为0。C01/C02身份与C03 ERP关联保留，旧实体/状态机字节保留于测试夹具。
