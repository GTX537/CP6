...
## 2026-09-10：C02 业务写入口与设计草案

- 完成现有租户、用户、部门、角色、会话族及直接 SQL 撤销入口的调查，形成 [C02 设计草案](../superpowers/specs/2026-09-10-c02-identity-events-design.md)。这里只记录设计准备，C02 业务实现、正式设计批准和真实跨仓验收均未完成。
