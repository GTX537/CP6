...
>
> 配套：`docs/product/00-功能盘点.md`（全量功能/缺口）、`docs/product/00-执行计划总盘.md`（既有 16 份计划与波次）。各缺口落地详情见各子文件：A1 计划/spec、A2 工艺路线、A3 固定资产、A4 银行对账、A5 预算（项目记忆均有对应条目）。
...
A 类已全收官，制造业 ERP "完整性"达成。往下走有四条候选线（详见 `docs/product/00-功能盘点.md` 第三/四章）：
...
*生成于 2026-06-17；2026-06-21 五项 A1~A5 全部完成，本文转为收官记录。现状据真实代码盘点（115 控制器 / 919 测试 +1skip）+ git 提交核对。下一阶段方向见第四章与 docs/product/00-功能盘点.md。*
