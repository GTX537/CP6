...
> **v1.3 估算说明**：以上为 v1.2 的历史全量粗估，保留用于追溯，不能作为当前剩余工作或承诺日期。v1.3 的实际剩余项必须根据现有实现、真实 CAD、自动化缺口、两仓 Pilot 和单一 DeliveryOwner 签署重新拆分；外部 AI Beta、规划/仿真 GA 与 Preview 能力单独估算，不与核心 GA 混报。
