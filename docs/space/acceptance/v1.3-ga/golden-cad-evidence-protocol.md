...
- 一个获批准的 Primary Provider 使用冻结 Source Set、黄金集、Worker 和 50 MiB 标准 CAD，资格分不低于 80。独立 Backup Provider 改为 GA 后韧性增强，不再阻断首版 Core GA。
- Overall 与 Out-of-sample：覆盖率≥80%、准确率≥90%、高置信度精确率≥95%、Wilson 下界≥90%、人工操作下降≥70%。
- Holdout 未报告 Blocking 遗漏为 0；Primary 至少 5 次性能观察，P95 到可审查≤15 分钟、受训用户首次 Ready≤60 分钟。
