...
no-ff 集成提交：`5b9b95ab11e5d7f22b7beb259dda18b02c2e830f`
...
验证和 no-ff 合并后，删除受控工作树内 36 个可重建 `bin/obj` 目录，共 6,566 个文件、
1,625,959,672 bytes（约 1.514 GiB）；源码、Migration、生成 SDK、报告和 Git 历史均保留。
