...
| 设计规格 | `docs/archive/erp-integration-202606/PHASE6_SPEC.md` | IntegrationEvent/重试/死信设计 |
...
- 文档：模块总册 §5.10(待补)、`docs/codemap-erp/05-受注-order.md`、`docs/archive/erp-integration-202606/PHASE6_SPEC.md`、页面盘点表
