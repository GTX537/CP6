...
> 销售模块其余页面（取引先、信用单、為替、OTD报表、Backorder、シート単价、版型木型、FSC）见文末 §12 待补清单。
...
|---|---|---|---|---|---|
| S-01 | 取引先マスタ | /business-partner(+/window) | Erp/BusinessPartnerController | BusinessPartner | 多Tab(得意先/仕入先/買掛/支払…)；删除限 Roles=1,Admin；详见 codemap-erp/01 |
...
| S-07 | シート単価マスタ | /sheet-unit-price | Erp/SheetUnitPriceController | SheetUnitPrice | 13项复合键定价 |
