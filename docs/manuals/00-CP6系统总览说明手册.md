...
新增/改动模块时必须遵守的硬规则（详见 `docs/architecture/PROJECT_STRUCTURE.md` §六）：
...
| 测试 | `CP6.Tests/` |
| 代码级实现手册（逐行） | `docs/architecture/CODEMAP.md` + `docs/codemap-{erp,mes,wms,fin,pur,wf,pub,plan}/` |
...
- 文档：`README.md`、`docs/architecture/PROJECT_STRUCTURE.md`、`docs/product/00-功能盘点.md`、`docs/architecture/CODEMAP.md`、`docs/codemap-erp/README.md`
