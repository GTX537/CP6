...
export interface ISpaceDesignV1Client {
     ...
     * @return Accepted
     */
    uploadExcelSource(versionId: string, file: FileParameter | undefined): Promise<UploadSpaceExcelSourceResponse>;

    /**
     * @return Accepted
     */
    startPreflight(versionId: string, sourceId: string, idempotency_Key: string, body: StartSpaceExcelPreflightRequest): Promise<StartSpaceExcelPreflightResponse>;

    /**
     * @param issueLimit (optional)
     * @return OK
     */
    getPreflight(versionId: string, sourceId: string, jobId: string, issueLimit: number | undefined): Promise<SpaceExcelPreflightDto>;

    /**
     * @return OK
     */
    downloadErrorReport(versionId: string, sourceId: string, jobId: string): Promise<FileResponse>;
    ...
    /**
     * @param sourceKind (optional)
     * @param workState (optional)
     * @param floorLogicalId (optional)
     * @param limit (optional)
     * @param cursor (optional)
     * @return OK
     */
    getCurrentPersonnel(siteId: string, sourceKind: string | undefined, workState: string | undefined, floorLogicalId: string | undefined, limit: number | undefined, cursor: string | undefined): Promise<SpacePersonnelCurrentPageDto>;
     ...
     * @return OK
     */
    downloadGlb(siteId: string, branchId: string): Promise<FileResponse>;
...
export class SpaceDesignV1Client implements ISpaceDesignV1Client {
     ...
     */
    uploadExcelSource(versionId: string, file: FileParameter | undefined): Promise<UploadSpaceExcelSourceResponse> {
        let url_ = this.baseUrl + "/api/space/design/v1/versions/{versionId}/excel-sources";
        if (versionId === undefined || versionId === null)
            throw new globalThis.Error("The parameter 'versionId' must be defined.");
        url_ = url_.replace("{versionId}", encodeURIComponent("" + versionId));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processUploadExcelSource(_response);
        });
    }

    protected processUploadExcelSource(response: Response): Promise<UploadSpaceExcelSourceResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 202) {
            return response.text().then((_responseText) => {
            let result202: any = null;
            let resultData202 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result202 = UploadSpaceExcelSourceResponse.fromJS(resultData202);
            return result202;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<UploadSpaceExcelSourceResponse>(null as any);
    }
     ...
     */
    startPreflight(versionId: string, sourceId: string, idempotency_Key: string, body: StartSpaceExcelPreflightRequest): Promise<StartSpaceExcelPreflightResponse> {
        let url_ = this.baseUrl + "/api/space/design/v1/versions/{versionId}/sources/{sourceId}/excel-preflights";
        if (versionId === undefined || versionId === null)
            throw new globalThis.Error("The parameter 'versionId' must be defined.");
        url_ = url_.replace("{versionId}", encodeURIComponent("" + versionId));
        if (sourceId === undefined || sourceId === null)
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processStartPreflight(_response);
        });
    }

    protected processStartPreflight(response: Response): Promise<StartSpaceExcelPreflightResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 202) {
            return response.text().then((_responseText) => {
            let result202: any = null;
            let resultData202 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result202 = StartSpaceExcelPreflightResponse.fromJS(resultData202);
            return result202;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<StartSpaceExcelPreflightResponse>(null as any);
    }
     ...
     */
    getPreflight(versionId: string, sourceId: string, jobId: string, issueLimit: number | undefined): Promise<SpaceExcelPreflightDto> {
        let url_ = this.baseUrl + "/api/space/design/v1/versions/{versionId}/sources/{sourceId}/excel-preflights/{jobId}?";
        if (versionId === undefined || versionId === null)
            throw new globalThis.Error("The parameter 'versionId' must be defined.");
        url_ = url_.replace("{versionId}", encodeURIComponent("" + versionId));
        if (sourceId === undefined || sourceId === null)
        ...
        url_ = url_.replace("{jobId}", encodeURIComponent("" + jobId));
        if (issueLimit === null)
            throw new globalThis.Error("The parameter 'issueLimit' cannot be null.");
        else if (issueLimit !== undefined)
            url_ += "issueLimit=" + encodeURIComponent("" + issueLimit) + "&";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetPreflight(_response);
        });
    }

    protected processGetPreflight(response: Response): Promise<SpaceExcelPreflightDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = SpaceExcelPreflightDto.fromJS(resultData200);
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<SpaceExcelPreflightDto>(null as any);
    }
     ...
     */
    downloadErrorReport(versionId: string, sourceId: string, jobId: string): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/space/design/v1/versions/{versionId}/sources/{sourceId}/excel-preflights/{jobId}/report";
        if (versionId === undefined || versionId === null)
            throw new globalThis.Error("The parameter 'versionId' must be defined.");
        url_ = url_.replace("{versionId}", encodeURIComponent("" + versionId));
        if (sourceId === undefined || sourceId === null)
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processDownloadErrorReport(_response);
        });
    }

    protected processDownloadErrorReport(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
     ...
     */
    getCurrentPersonnel(siteId: string, sourceKind: string | undefined, workState: string | undefined, floorLogicalId: string | undefined, limit: number | undefined, cursor: string | undefined): Promise<SpacePersonnelCurrentPageDto> {
        let url_ = this.baseUrl + "/api/space/design/v1/sites/{siteId}/personnel?";
        if (siteId === undefined || siteId === null)
            throw new globalThis.Error("The parameter 'siteId' must be defined.");
        url_ = url_.replace("{siteId}", encodeURIComponent("" + siteId));
        if (sourceKind === null)
            ...
            url_ += "sourceKind=" + encodeURIComponent("" + sourceKind) + "&";
        if (workState === null)
            throw new globalThis.Error("The parameter 'workState' cannot be null.");
        else if (workState !== undefined)
            url_ += "workState=" + encodeURIComponent("" + workState) + "&";
        if (floorLogicalId === null)
            throw new globalThis.Error("The parameter 'floorLogicalId' cannot be null.");
        else if (floorLogicalId !== undefined)
            url_ += "floorLogicalId=" + encodeURIComponent("" + floorLogicalId) + "&";
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetCurrentPersonnel(_response);
        });
    }

    protected processGetCurrentPersonnel(response: Response): Promise<SpacePersonnelCurrentPageDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = SpacePersonnelCurrentPageDto.fromJS(resultData200);
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<SpacePersonnelCurrentPageDto>(null as any);
    }
     ...
     */
    getPersonnelTrajectory(siteId: string, personExternalId: string, sourceId: string, fromUtc: Date, toUtc: Date, limit: number | undefined, cursor: string | undefined): Promise<SpacePersonnelTrajectoryResponse> {
        let url_ = this.baseUrl + "/api/space/design/v1/sites/{siteId}/personnel/trajectory?";
        if (siteId === undefined || siteId === null)
            throw new globalThis.Error("The parameter 'siteId' must be defined.");
        url_ = url_.replace("{siteId}", encodeURIComponent("" + siteId));
        if (personExternalId === undefined || personExternalId === null)
            throw new globalThis.Error("The parameter 'personExternalId' must be defined and cannot be null.");
        else
            url_ += "personExternalId=" + encodeURIComponent("" + personExternalId) + "&";
        if (sourceId === undefined || sourceId === null)
            throw new globalThis.Error("The parameter 'sourceId' must be defined and cannot be null.");
        else
            url_ += "sourceId=" + encodeURIComponent("" + sourceId) + "&";
        if (fromUtc === undefined || fromUtc === null)
            throw new globalThis.Error("The parameter 'fromUtc' must be defined and cannot be null.");
        else
            url_ += "fromUtc=" + encodeURIComponent(fromUtc ? "" + fromUtc.toISOString() : "") + "&";
        if (toUtc === undefined || toUtc === null)
            throw new globalThis.Error("The parameter 'toUtc' must be defined and cannot be null.");
        else
            url_ += "toUtc=" + encodeURIComponent(toUtc ? "" + toUtc.toISOString() : "") + "&";
        if (limit === null)
            throw new globalThis.Error("The parameter 'limit' cannot be null.");
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetPersonnelTrajectory(_response);
        });
    }

    protected processGetPersonnelTrajectory(response: Response): Promise<SpacePersonnelTrajectoryResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = SpacePersonnelTrajectoryResponse.fromJS(resultData200);
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<SpacePersonnelTrajectoryResponse>(null as any);
    }
     ...
     */
    downloadGlb(siteId: string, branchId: string): Promise<FileResponse> {
        let url_ = this.baseUrl + "/api/space/planning/v1/sites/{siteId}/scenario-branches/{branchId}/exports/gltf";
        if (siteId === undefined || siteId === null)
            throw new globalThis.Error("The parameter 'siteId' must be defined.");
        url_ = url_.replace("{siteId}", encodeURIComponent("" + siteId));
        if (branchId === undefined || branchId === null)
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processDownloadGlb(_response);
        });
    }

    protected processDownloadGlb(response: Response): Promise<FileResponse> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200 || status === 206) {
            const contentDisposition = response.headers ? response.headers.get("content-disposition") : undefined;
...
export class SpaceExcelPreflightDto implements ISpaceExcelPreflightDto {
    jobId!: string;
    modelVersionId!: string;
    sourceId!: string;
    status!: string;
    ...
    issues!: SpaceExcelPreflightIssueDto[];

    constructor(data?: ISpaceExcelPreflightDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.mappingDefinitionHash = _data["mappingDefinitionHash"];
            ...
            this.sheetCount = _data["sheetCount"];
            this.dataRowCount = _data["dataRowCount"];
            this.validRowCount = _data["validRowCount"];
            this.returnedIssueCount = _data["returnedIssueCount"];
            this.issuesTruncated = _data["issuesTruncated"];
            this.errorReportUrl = _data["errorReportUrl"];
            if (Array.isArray(_data["issues"])) {
                this.issues = [] as any;
                for (let item of _data["issues"])
                    this.issues!.push(SpaceExcelPreflightIssueDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): SpaceExcelPreflightDto {
        data = typeof data === 'object' ? data : {};
        let result = new SpaceExcelPreflightDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["mappingDefinitionHash"] = this.mappingDefinitionHash;
        ...
        data["sheetCount"] = this.sheetCount;
        data["dataRowCount"] = this.dataRowCount;
        data["validRowCount"] = this.validRowCount;
        data["returnedIssueCount"] = this.returnedIssueCount;
        data["issuesTruncated"] = this.issuesTruncated;
        data["errorReportUrl"] = this.errorReportUrl;
        if (Array.isArray(this.issues)) {
            data["issues"] = [];
            for (let item of this.issues)
                data["issues"].push(item ? item.toJSON() : undefined as any);
...
export interface ISpaceExcelPreflightDto {
    jobId: string;
    modelVersionId: string;
    sourceId: string;
    status: string;
...
export class SpaceExcelPreflightIssueDto implements ISpaceExcelPreflightIssueDto {
    id!: string;
    severity!: string;
    code!: string;
    sheet?: string | undefined;
    ...
    constructor(data?: ISpaceExcelPreflightIssueDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): SpaceExcelPreflightIssueDto {
        data = typeof data === 'object' ? data : {};
        let result = new SpaceExcelPreflightIssueDto();
        result.init(data);
        return result;
    }
...
export interface ISpaceExcelPreflightIssueDto {
    id: string;
    severity: string;
    code: string;
    sheet?: string | undefined;
...
export class SpacePersonnelCurrentDto implements ISpacePersonnelCurrentDto {
    sourceId!: string;
    sourceKind!: string;
    ...
    positionEventId!: string | undefined;
    positionSourceEventId!: string | undefined;
    workStateOccurredAtUtc!: Date | undefined;
    workStateReceivedAtUtc!: Date | undefined;
    workStateEventId!: string | undefined;
    workStateSourceEventId!: string | undefined;
    positionAgeMilliseconds!: number | undefined;
    workStateAgeMilliseconds!: number | undefined;
    hasPosition!: boolean;
    positionIsStale!: boolean;
    workStateIsStale!: boolean;
    isSimulated!: boolean;

    constructor(data?: ISpacePersonnelCurrentDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.positionEventId = _data["positionEventId"];
            this.positionSourceEventId = _data["positionSourceEventId"];
            this.workStateOccurredAtUtc = _data["workStateOccurredAtUtc"] ? new Date(_data["workStateOccurredAtUtc"].toString()) : undefined as any;
            this.workStateReceivedAtUtc = _data["workStateReceivedAtUtc"] ? new Date(_data["workStateReceivedAtUtc"].toString()) : undefined as any;
            this.workStateEventId = _data["workStateEventId"];
            this.workStateSourceEventId = _data["workStateSourceEventId"];
            this.positionAgeMilliseconds = _data["positionAgeMilliseconds"];
            this.workStateAgeMilliseconds = _data["workStateAgeMilliseconds"];
            this.hasPosition = _data["hasPosition"];
            this.positionIsStale = _data["positionIsStale"];
            this.workStateIsStale = _data["workStateIsStale"];
            this.isSimulated = _data["isSimulated"];
        }
    }

    static fromJS(data: any): SpacePersonnelCurrentDto {
        data = typeof data === 'object' ? data : {};
        let result = new SpacePersonnelCurrentDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["positionEventId"] = this.positionEventId;
        data["positionSourceEventId"] = this.positionSourceEventId;
        data["workStateOccurredAtUtc"] = this.workStateOccurredAtUtc ? this.workStateOccurredAtUtc.toISOString() : undefined as any;
        data["workStateReceivedAtUtc"] = this.workStateReceivedAtUtc ? this.workStateReceivedAtUtc.toISOString() : undefined as any;
        data["workStateEventId"] = this.workStateEventId;
        data["workStateSourceEventId"] = this.workStateSourceEventId;
        data["positionAgeMilliseconds"] = this.positionAgeMilliseconds;
        data["workStateAgeMilliseconds"] = this.workStateAgeMilliseconds;
        data["hasPosition"] = this.hasPosition;
        data["positionIsStale"] = this.positionIsStale;
        data["workStateIsStale"] = this.workStateIsStale;
        data["isSimulated"] = this.isSimulated;
        return data;
    }
}

export interface ISpacePersonnelCurrentDto {
    sourceId: string;
    sourceKind: string;
    personExternalId: string;
    workState: string;
...
export class SpacePersonnelCurrentPageDto implements ISpacePersonnelCurrentPageDto {
    siteId!: string;
    asOfUtc!: Date;
    freshnessThresholdSeconds!: number;
    items!: SpacePersonnelCurrentDto[];
    nextCursor!: string | undefined;

    constructor(data?: ISpacePersonnelCurrentPageDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(SpacePersonnelCurrentDto.fromJS(item));
            }
            this.nextCursor = _data["nextCursor"];
        }
    }

    static fromJS(data: any): SpacePersonnelCurrentPageDto {
        data = typeof data === 'object' ? data : {};
        let result = new SpacePersonnelCurrentPageDto();
        result.init(data);
        return result;
    }
...
export interface ISpacePersonnelCurrentPageDto {
    siteId: string;
    asOfUtc: Date;
    freshnessThresholdSeconds: number;
    items: SpacePersonnelCurrentDto[];
...
export class SpacePersonnelTrajectoryPointDto implements ISpacePersonnelTrajectoryPointDto {
    eventId!: string;
    sourceEventId!: string;
    floorLogicalId!: string | undefined;
    locationLogicalId!: string | undefined;
    ...
    constructor(data?: ISpacePersonnelTrajectoryPointDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.occurredAtUtc = _data["occurredAtUtc"] ? new Date(_data["occurredAtUtc"].toString()) : undefined as any;
            this.receivedAtUtc = _data["receivedAtUtc"] ? new Date(_data["receivedAtUtc"].toString()) : undefined as any;
            this.ingestDelayMilliseconds = _data["ingestDelayMilliseconds"];
        }
    }

    static fromJS(data: any): SpacePersonnelTrajectoryPointDto {
        data = typeof data === 'object' ? data : {};
        let result = new SpacePersonnelTrajectoryPointDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["occurredAtUtc"] = this.occurredAtUtc ? this.occurredAtUtc.toISOString() : undefined as any;
        data["receivedAtUtc"] = this.receivedAtUtc ? this.receivedAtUtc.toISOString() : undefined as any;
        data["ingestDelayMilliseconds"] = this.ingestDelayMilliseconds;
        return data;
    }
}

export interface ISpacePersonnelTrajectoryPointDto {
    eventId: string;
    sourceEventId: string;
    floorLogicalId: string | undefined;
    locationLogicalId: string | undefined;
...
export class SpacePersonnelTrajectoryResponse implements ISpacePersonnelTrajectoryResponse {
    siteId!: string;
    sourceId!: string;
    sourceKind!: string;
    personExternalId!: string;
    ...
    constructor(data?: ISpacePersonnelTrajectoryResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.sourceKind = _data["sourceKind"];
            this.personExternalId = _data["personExternalId"];
            this.fromUtc = _data["fromUtc"] ? new Date(_data["fromUtc"].toString()) : undefined as any;
            this.toUtc = _data["toUtc"] ? new Date(_data["toUtc"].toString()) : undefined as any;
            this.retentionCutoffUtc = _data["retentionCutoffUtc"] ? new Date(_data["retentionCutoffUtc"].toString()) : undefined as any;
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(SpacePersonnelTrajectoryPointDto.fromJS(item));
            }
            this.nextCursor = _data["nextCursor"];
        }
    }

    static fromJS(data: any): SpacePersonnelTrajectoryResponse {
        data = typeof data === 'object' ? data : {};
        let result = new SpacePersonnelTrajectoryResponse();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["retentionCutoffUtc"] = this.retentionCutoffUtc ? this.retentionCutoffUtc.toISOString() : undefined as any;
        if (Array.isArray(this.items)) {
            data["items"] = [];
            for (let item of this.items)
                data["items"].push(item ? item.toJSON() : undefined as any);
...
export interface ISpacePersonnelTrajectoryResponse {
    siteId: string;
    sourceId: string;
    sourceKind: string;
    personExternalId: string;
...
export class StartSpaceExcelPreflightRequest implements IStartSpaceExcelPreflightRequest {
    ...
    constructor(data?: IStartSpaceExcelPreflightRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): StartSpaceExcelPreflightRequest {
        data = typeof data === 'object' ? data : {};
        let result = new StartSpaceExcelPreflightRequest();
        result.init(data);
        return result;
    }
...
export interface IStartSpaceExcelPreflightRequest {
    mappingProfileId: string;
    mappingProfileVersion: number;
}

export class StartSpaceExcelPreflightResponse implements IStartSpaceExcelPreflightResponse {
    jobId!: string;
    jobStatus!: string;
    jobStatusUrl!: string;
    previewUrl!: string;
    ...
    constructor(data?: IStartSpaceExcelPreflightResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
        ...
        if (!data) {
            this.source = new SpaceSourceDto();
        }
    }
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.mappingProfileVersion = _data["mappingProfileVersion"];
            this.mappingDefinitionHash = _data["mappingDefinitionHash"];
            this.source = _data["source"] ? SpaceSourceDto.fromJS(_data["source"]) : new SpaceSourceDto();
            this.idempotentReplay = _data["idempotentReplay"];
        }
    }

    static fromJS(data: any): StartSpaceExcelPreflightResponse {
        data = typeof data === 'object' ? data : {};
        let result = new StartSpaceExcelPreflightResponse();
        result.init(data);
        return result;
    }
...
export interface IStartSpaceExcelPreflightResponse {
    jobId: string;
    jobStatus: string;
    jobStatusUrl: string;
    previewUrl: string;
...
export class UploadSpaceExcelSourceResponse implements IUploadSpaceExcelSourceResponse {
    ...
    constructor(data?: IUploadSpaceExcelSourceResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.file = _data["file"] ? SpaceFileDto.fromJS(_data["file"]) : new SpaceFileDto();
            this.source = _data["source"] ? SpaceSourceDto.fromJS(_data["source"]) : new SpaceSourceDto();
    ...
    static fromJS(data: any): UploadSpaceExcelSourceResponse {
        data = typeof data === 'object' ? data : {};
        let result = new UploadSpaceExcelSourceResponse();
        result.init(data);
        return result;
    }
...
export interface IUploadSpaceExcelSourceResponse {
    file: SpaceFileDto;
    source: SpaceSourceDto;
    scanJobId?: string | undefined;
    jobStatusUrl?: string | undefined;
