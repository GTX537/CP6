<template>
  <el-form :model="model" label-width="120px" size="small">
    <el-row :gutter="16">
      <el-col :span="8">
        <el-form-item label="指図NO">
          <el-input v-model="model.workOrderNo" disabled placeholder="保存後に自動採番" />
        </el-form-item>
      </el-col>
      <el-col :span="8">
        <el-form-item label="拠点CD" required>
    ...
    <el-divider content-position="left">製品情報</el-divider>
    <el-row :gutter="16">
      <el-col :span="6">
    ...
    <el-divider content-position="left">数量・納期</el-divider>
    <el-row :gutter="16">
      <el-col :span="6">
        <el-form-item label="生産数量" required>
