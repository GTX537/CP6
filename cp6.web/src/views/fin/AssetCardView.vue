  ...
  <div class="asset-card">
    ...
    <el-card shadow="never">
      <div class="table-toolbar">
        ...
        <el-button v-permission="'fin-asset-card:add'" type="primary" size="small" @click="openAdd">{{ t('新建') }}</el-button>
      ...
      <el-table :data="rows" border stripe size="small" max-height="620" v-loading="loading">
        ...
        <el-table-column :label="t('操作')" width="180" fixed="right">
          <template #default="{ row }">
            <el-button link type="primary" size="small" v-if="row.status === 0" v-permission="'fin-asset-card:activate'" @click="activate(row)">{{ t('asset.action.activate') }}</el-button>
