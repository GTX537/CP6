      ...
      <el-card style="flex: 1">
        <template #header>
          <div style="display: flex; justify-content: space-between; align-items: center; gap: 12px">
            <el-select v-model="selectedResourceKey" placeholder="选择资源" style="width: 200px" @change="applyAccessMap">
              <el-option v-for="r in resources" :key="r.key" :label="r.key" :value="r.key" />
            </el-select>
            <el-button type="primary" :disabled="!selectedRoleId || !selectedResourceKey" @click="save">保存</el-button>
          </div>
        </template>
