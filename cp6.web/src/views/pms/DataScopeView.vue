    ...
    <div style="display: flex; gap: 20px">
      ...
      <el-card style="flex: 1">
        ...
        <el-table :data="resources" border>
          <el-table-column prop="name" :label="t('资源')" width="160" />
          <el-table-column :label="t('数据范围')" width="200">
          ...
          <el-table-column :label="t('自定义部门（范围=自定义时）')">
            <template #default="{ row }">
              <el-tree-select
...
const SCOPE_LABELS: Record<number, string> = {
  1: t('本人'), 2: t('本部门'), 3: t('本部门及下级'), 4: t('自定义部门'), 5: t('全部')
}
