<template>
  <el-card shadow="never">
    ...
    >
      ...
      <el-row :gutter="12">
        <el-col :span="8">
          <el-form-item label="得意先 CD" required>
        ...
        <el-col :span="8">
          <el-form-item label="親子区分">
            <el-select v-model="store.basicInfo.parentChildDiv" :disabled="!store.canEdit">
              <el-option label="0=親" value="0" />
              <el-option label="1=子" value="1" />
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="セット比率">
      ...
      <!-- ========== 区块 2：品名・品番 ========== -->
      <el-divider content-position="left">品名・品番</el-divider>
      <el-row :gutter="12">
        <el-col :span="8">
          <el-form-item label="顧客品名 1" required>
      ...
      <!-- ========== 区块 3：原紙構成 ========== -->
      <el-divider content-position="left">原紙構成（表/中/裏）</el-divider>
      <el-row :gutter="12">
        <el-col :span="6">
      ...
      <!-- ========== 区块 5：売価・運賃 ========== -->
      <el-divider content-position="left">売価・運賃・単位</el-divider>
      <el-row :gutter="12">
        <el-col :span="6">
          <el-form-item label="売価区分" required>
            <el-select v-model="store.basicInfo.salesPriceDiv" :disabled="!store.canEdit">
              <el-option label="1=ｾｯﾄｳﾘ" value="1" />
              <el-option label="2=ﾀﾝﾋﾟﾝｳﾘ" value="2" />
              <el-option label="3=ｱｿｰﾄ" value="3" />
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="運賃請求" required>
            <el-select v-model="store.basicInfo.freightBilling" :disabled="!store.canEdit">
              <el-option label="0=込み" value="0" />
              <el-option label="1=別途" value="1" />
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="数量単位">
            <el-tooltip
              v-if="store.basicInfo.isReadOnlyByOrder"
              content="受注実績があるため変更できません"
              placement="top"
            >
              <el-input v-model="store.basicInfo.qtyUnit" disabled placeholder="受注後変更不可" />
            </el-tooltip>
            <el-input
              v-else
      ...
      <el-divider content-position="left">戦略商品区分（Rev.5）</el-divider>
